      ...
      <nav className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto px-4 h-20 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-2xl tracking-tight text-primary">Let's Fly Together</span>
          </div>
      ...
      <section id="services" className="py-24 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
            <h2 className="text-5xl font-bold tracking-tight text-slate-900">Discover Our Services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={idx} className="border-none shadow-sm hover:shadow-xl transition-all duration-300 group bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <Button size="lg" className="px-10 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 font-bold">
