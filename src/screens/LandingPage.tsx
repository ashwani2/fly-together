          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-lg">
                ...
                seeking to further their education and pursue their career goals
                worldwide.
              </p>
            ...
            >
              ...
              {/* Floating Cards */}
              <div className="absolute -top-6 -right-6 bg-white p-4 rounded-2xl shadow-xl z-20 flex items-center gap-3 border animate-bounce-slow">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-2xl shadow-xl z-20 flex items-center gap-3 border animate-pulse-slow">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-6">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              We at Let's Fly Together Consultants are available to help you at
              every stage of your academic career. Our services are intended to
              help you make the best decisions for your future by offering
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={idx}
                className="border-none shadow-sm hover:shadow-xl transition-all duration-300 group bg-white"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-secondary rounded-full flex items-center justify-center text-white shadow-2xl border-8 border-white">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-muted-foreground">
                Our mission is to empower students to change the world. We don't
                just help with applications; we build the foundation for your
                global career.
              </p>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li className="mt-4">
                  <Button className="w-full bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 rounded-full h-12 font-bold group">
                    Book Consultation
